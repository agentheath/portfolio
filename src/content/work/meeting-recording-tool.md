...
description: "User guide for an enterprise VC recording and streaming platform used to document 250+ meetings per day across the company."
tags: ["User Guide", "Enterprise", "Internal Tool"]
metric: "250+"
metricLabel: "meetings/day"
problem: "A company needed a way to record and stream 250+ daily meetings for asynchronous viewing, with two different retention policies for meetings vs. trainings. Employees needed to schedule recordings in advance, initiate them from calendar tools, or start them mid-meeting — each requiring distinct workflows."
approach: "I mapped each user journey (schedule in advance, calendar-initiated, in-progress recording) as separate sections, surfacing the critical IMPORTANT callout about manual stream start — a common failure point — in context where users would encounter it. I documented field-by-field UI walkthroughs and kept retention policy differences visible throughout."
outcome: "Accurate, task-based documentation at the scale the tool required. The guide prevented the most common support inquiry (why didn't my stream start automatically?) by proactively surfacing that requirement at the exact decision point in the workflow."
---
