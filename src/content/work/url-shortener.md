...
description: "Task-based how-to guide covering five distinct methods for creating and managing internal short URLs."
tags: ["How-to Guide", "Internal Tool"]
problem: "An internal URL shortening tool offered multiple ways to create short URLs — a web form, right-click menu, browser extension, and keyboard shortcuts — but users only knew about the basic web form, leaving the more efficient methods undiscovered."
approach: "I organized the guide around a single user goal (Create a Short URL) and presented each method in order of increasing integration depth: basic UI, custom stringkey, right-click, browser extension, keyboard shortcut. Each method is self-contained with clear prerequisites stated upfront, so users can jump directly to the method that fits their workflow."
outcome: "Users gained awareness of five distinct workflows for a tool they already had access to. The keyboard shortcut and browser extension sections, in particular, surfaced time-saving options that had low discoverability prior to documentation."
---
...
Create a URL in the format `url-shortener.com/<custom stringkey>`. These are much easier to remember than randomized URLs.
