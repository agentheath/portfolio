...
Mattermost is an open-source communications/chat platform modeled after Slack. I wrote docs to aid the deployment at scale of an internally hosted instance of Mattermost meant to serve as a backup communications platform and remediation tool in case of an internal infrastructure outage.
