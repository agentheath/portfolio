...
2. You'll be prompted to sign in to _SSO Service_. Click on the _SSO Service_ button to initiate the SSO login.
...
3. You'll then be prompted for two-factor authentication. You can do so via your hardware authentication device in your laptop or the Google app on your work phone.
